...
<div class="food_list">
    <form class="form" action="/food/UserRegisterServlet" method="post" onsubmit="return validate()">
        <div class="form-group">
            <label for="name">用户名:</label>
            <input type="text" id="name" name="username" class="username" placeholder="请输入长度位5-15位的用户名">
        ...
        <div class="form-group">
            ...
            <input type="text" id="email" name="email" class="email" placeholder="请输入邮箱地址">
