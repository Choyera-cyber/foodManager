...
<div class="food_list">
    <form action="/food/FoodAddServlet" method="post"
          enctype="multipart/form-data" onsubmit="return validate();" class="form">
        <div class="form-group">
            <label for="foodname">食品名:</label>
            <input type="text" id="foodname" name="foodname" class="foodname">
            <p class="error userInfo"></p>
        </div>
        <div class="form-group">
            <label for="foodprice">价格:</label>
            <input type="text" id="foodprice" name="foodprice" class="foodprice">
            <p class="error userInfo"></p>
        </div>
        <div class="form-group">
            <label for="foodnum">库存量:</label>
            <input type="text" id="foodnum" name="foodnum" class="foodnum">
            <p class="error userInfo"></p>
        </div>
        <div>
